...
import pe.edu.upc.center.jameoFit.tracking.application.internal.commandservices.MacronutrientValuesCommandServiceImpl;
import pe.edu.upc.center.jameoFit.tracking.application.internal.commandservices.TrackingGoalCommandServiceImpl;
...
import pe.edu.upc.center.jameoFit.tracking.interfaces.rest.transform.TrackingGoalResourceFromEntityAssembler;
...
public class TrackingGoalController {
    ...
    public ResponseEntity<Long> createTrackingGoal(@RequestBody CreateTrackingGoalResource resource) {
        ...
        // Ejecutar la lÃ³gica del dominio
